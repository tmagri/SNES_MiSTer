module main (
	...
	output      [7:0] VRAM1_DO,
	output            VRAM1_WE_N,
	output     [15:0] VRAM1_ADDR_B,
	input       [7:0] VRAM1_DI_B,
	output     [15:0] VRAM2_ADDR,
	input       [7:0] VRAM2_DI,
	output      [7:0] VRAM2_DO,
	output            VRAM2_WE_N,
	output     [15:0] VRAM2_ADDR_B,
	input       [7:0] VRAM2_DI_B,
	output            VRAM_OE_N,
...
(
	...
	.vram_addra_b(VRAM1_ADDR_B),
	.vram_addrb_b(VRAM2_ADDR_B),
	.vram_dai(VRAM1_DI),
	.vram_dbi(VRAM2_DI),
	.vram_dai_b(VRAM1_DI_B),
	.vram_dbi_b(VRAM2_DI_B),
	.vram_dao(VRAM1_DO),
	.vram_dbo(VRAM2_DO),
	.vram_rd_n(VRAM_OE_N),
